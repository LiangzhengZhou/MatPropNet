...
def _resolve_repo_root():
    package_root = os.path.abspath(ocpmodels.__path__[0])
    return os.path.abspath(os.path.join(package_root, os.pardir))


def _safe_git_describe():
    ...
    try:
        return (
            subprocess.check_output(
                ["git", "-C", repo_root, "describe", "--always"],
